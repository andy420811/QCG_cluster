...
##  for j in 25 30 35 40 45 60
	do	
		...
		##cd s"$j"_w1.0
		sed -i "s/crest input.xyz --qcg water.xyz --chrg 0 --uhf 0 --nsolv 60 --T 25 --gsolv --nclus 20 --gbsa water > crest.out/crest input.xyz --qcg water.xyz --chrg 1 --uhf 0 --nsolv "$j" --T 40 --gsolv --nclus 20 --gbsa water > crest.out/" sub.sh
		echo $i $j

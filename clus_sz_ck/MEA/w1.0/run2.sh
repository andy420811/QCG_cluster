...
do
    ...
    do
        ...
        ## the basis cmd is nsolv 60
        
        ##cd s"$j"_w1.0
		sed -i "s/crest input.xyz --qcg water.xyz --chrg 0 --uhf 0 --nsolv 60 --T 25 --gsolv --nclus 20 --gbsa water > crest.out/crest input.xyz --qcg water.xyz --chrg 0 --uhf 0 --nsolv "$j" --T 25 --gsolv --nclus 20 --gbsa water --wscal 1.0 > crest.out/" sub.sh

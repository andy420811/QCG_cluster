...
#PBS -l select=1:ncpus=25:mem=360gb
#PBS -q cf40
#PBS -P MST111382
#PBS -j oe
...
export OMP_STACKSIZE=360G     ## memory size
export OMP_NUM_THREADS=25,1  ## cores used

## execute command line
crest input.xyz --qcg water.xyz --chrg 0 --uhf 0 --nsolv 100 --wscal 1.0  --T 25 --gsolv --nclus 20 --gbsa water > crest.out
